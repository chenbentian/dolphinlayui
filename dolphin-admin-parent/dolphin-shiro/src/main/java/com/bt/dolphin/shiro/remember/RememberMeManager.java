package com.bt.dolphin.shiro.remember;
...
import com.bt.dolphin.common.util.EntityBeanUtil;
...
public class RememberMeManager extends CookieRememberMeManager {
    ...
    protected byte[] serialize(PrincipalCollection principals) {
        ...
        SysUserVo principal = (SysUserVo) EntityBeanUtil.cloneBean(SysUserVo, ignores);

        // 二次加密用户密码
        String password = ShiroUtil.encrypt(SysUserVo.getUserStatus(), SysUserVo.getSalt());
    ...
    protected PrincipalCollection deserialize(byte[] serializedIdentity) {
        ...
        SysUserVo principal = (SysUserVo) collection.getPrimaryPrincipal();
        ...
        // 判断二次加密密码盐是否正确
        String password = principal.getUserPassword();
